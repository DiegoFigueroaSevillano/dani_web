...
const Approach = () => {
  return (
    <section className="w-full py-20">
      {/* Cambiar el título a "Pasos que seguiremos" */}
      <h1 className="heading">
        <span className="text-purple">Pasos que seguiremos</span>
      </h1>
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="En esta etapa, exploraremos quién eres: tus intereses, habilidades y valores.
          Es el momento de reflexionar sobre tu identidad y lo que te apasiona."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        {/* Paso 2: Eligiendo mis caminos */}
        <Card
          title="Eligiendo mis caminos"
          icon={<AceternityIcon order="Paso 2" />}
          des="Aquí evaluaremos las diferentes opciones de carrera que tienes disponibles.
          Analizaremos tus fortalezas y lo que te gustaría lograr a largo plazo."
        >
          <CanvasRevealEffect
            animationSpeed={3}
        ...
        {/* Paso 3: Mis potencialidades y mis limitaciones */}
        <Card
          title="Mis potencialidades y mis limitaciones"
          icon={<AceternityIcon order="Paso 3" />}
          des="En este último paso, identificaremos las habilidades y recursos que puedes potenciar,
          así como las áreas donde necesitarás más apoyo o desarrollo."
        >
          <CanvasRevealEffect
            animationSpeed={3}
...
// Icono para los pasos numerados
